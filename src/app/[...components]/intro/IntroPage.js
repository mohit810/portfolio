  ...
  return (
    <div className="h-full grid grid-flow-col grid-cols-1">
      <div className="mx-20 my-auto text-lg font-semibold transition ease-in-out delay-150">
        ...
        I juggle both front-end and back-end development, ensuring every pixel
        and line of code works together to create an exceptional user
        experience. Let's build something amazing together!
      </div>
    </div>
  );
};
